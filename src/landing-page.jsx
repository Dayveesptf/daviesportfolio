...
function LandingPage() {
  ...
  return (
    <>
      <Navbar />
      <div className='bg-gradient-to-tr from-black to-gray-800 slide-top1 sections flex flex-col md:w-[100%] md:px-[5%] mt-16 items-center h-[80vh] md:h-[100vh] md:py-24 lg:py-10 z-20' ref={el => sectionsRef.current[0] = el}>
        <p className='mt-36 md:mt-24 text-gray-500 tracking-widest'>DYNAMIC WEB MAGIC</p>
        <h1 className='mt-6 text-center lg:mt-10 text-4xl md:text-6xl w-[94%] lg:w-[70%] text-gray-400'>Transforming Concepts into seamless <span className='text-gray-100'>User Experiences</span></h1>
        <p className='md:text-lg lg:text-xl lg:mt-10 mx-auto text-center mt-6 w-[90%] text-gray-500'>Hi! I&apos;m Davies David, a Frontend Developer based in Nigeria</p>
        <Link to="./projects" className='mt-6 hover:px-7 lg:mt-10 hover:py-3 bg-gradient-to-tr from-gray-200 hover:from-gray-700 hover:to-gray-400 to-gray-500 px-6 text-base py-2 rounded-lg transition-all duration-200'>See my work</Link>
      </div>
      <br />
      <br />
      ...
      <div className='py-6 gap-5 lg:gap-20 sections grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mx-auto w-[86%] ml-[7%] md:w-[80%] md:ml-[10%] lg:w-[90%] lg:ml-[5%]' ref={addToRefs}>
        ...
        <div className='glass relative p-8 overflow-hidden rounded-2xl bg-[#ffffff25] shadow-lg shadow-[#565656] backdrop-blur-xl'>
          ...
          <div className='flex mt-7 justify-between w-full mx-auto px-7 items-center'>
            ...
            <a href="https://retail-radar-dd.vercel.app/" className=' text-gray-200 px-3 py-2 rounded-md bg-white/10 hover:bg-white/30 hover:text-black transition'>Check it out</a>
          </div>
        </div>
      </div>

      <h1 className='text-center text-2xl md:text-3xl lg:text-4xl mt-24 md:mt-40 mb-6 md:mb-12 w-5/6 mx-auto text-gray-500'>My <span className='text-gray-200'>work experience</span></h1>

      <div className='slider sections flex flex-col justify-center gap-10 md:flex-row gap-y-4 items-center z-20 w-[80%] ml-[10%] bg-black pb-20' ref={addToRefs}>
        <div className='md:w-[25%] md:py-20 bg-[#4343434c] rounded-3xl w-[100%] shadow-bottom-only shadow-gray-600 border-solid border-2 py-6 text-center'>
          ...
          <h1 className='mt-2 md:text-xl md:mt-5 text-lg tracking-normal font-bold text-white'>Zeinny Crafts</h1>
          <hr className='mt-6 w-[20%] ml-[40%]'/>
          <p className='mt-3 md:text-sm w-5/6 text-[12px] mx-auto text-gray-400'>Assisted in the development of an eCommerce web platform using TypeScript, enhancing interactivity</p>
          <hr className='mt-6 w-[20%] ml-[40%]'/>
        </div>
        <div className='md:w-[25%] md:py-20 bg-[#4343434c] rounded-3xl w-[100%] shadow-bottom-only shadow-gray-600 border-solid border-2 py-6 text-center'>
          <h1 className='text-xs md:text-sm underline underline-offset-2 text-gray-400'>Frontend Engineer Intern</h1>
